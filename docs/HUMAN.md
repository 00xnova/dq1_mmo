...
<p align="center">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-709-059669?style=for-the-badge" />
...
**Version:** 0.5.137 · **709** tests · matches `server/config.py` → `VERSION`
...
Live version badges above match `server/config.py` → `VERSION` (**0.5.137** · **709** tests).
