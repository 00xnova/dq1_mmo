...
<p align="center">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-570-059669?style=for-the-badge" />
...
**Version:** 0.5.113 · **570** tests · matches `server/config.py` → `VERSION`

**Recent for players/ops (v0.5.113):** far **`/wave`** stays reliable · **`/last`** shows near/far · AFK tip on directed emotes · **570** tests.
...
Live version badges above match `server/config.py` → `VERSION` (**0.5.113** · **570** tests).
