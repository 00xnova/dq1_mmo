"""v0.5.128: self peeks multiplayer context · version."""
...
def test_self_peeks_ws(tmp_path, monkeypatch):
    ...
    try:
        ta, ca = register_char(base, "sf@ex.com", "Sf", "SelfA")
        ...
        async def flow():
            ...
            async with websockets.connect(ws_url) as ws:
                ...
                for typ, expect in (
                    ...
                    m = await recv_until(ws, expect, "error")
                    assert m.get("type") == expect, m
